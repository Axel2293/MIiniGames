...
void pong_loop(char[VERTICAL][HORIZONTAL], int, int, int, int, int, int, int, int, int);
void draw(char [VERTICAL][HORIZONTAL], int, int);
void input(char [VERTICAL][HORIZONTAL], int *,int *, int *, int *, int *, int *, int *, int *, int *, int *, int *);
...
int pong(){
    ...
    pong_loop(field, ballx, bally, inijug, finjug, iniia, finia, modx, mody, modia);
...
void pong_loop(char field[VERTICAL][HORIZONTAL], int ballx,int bally, int inijug, int finjug, int iniia, int finia, int modx, int mody, int modia){
    int score_player=0, score_ia=0;
    do{
        draw(field, score_player, score_ia);
        input(field, &ballx, &bally, &inijug, &finjug, &iniia, &finia, &modx, &mody, &modia, &score_player, &score_ia);
...
void input(char field[VERTICAL][HORIZONTAL], int *ballx,int *bally, int *inijug, int *finjug, int *iniia, int *finia, int *modx, int *mody, int *modia, int *score_player, int *score_ia){
